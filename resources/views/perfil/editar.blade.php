<x-app-layout>
    <div class="flex min-h-screen bg-black text-red-500">
        ...
        <main class="flex-1 p-10">
            <h1 class="text-4xl font-bold mb-8">Editar Conta</h1>

            <form class="space-y-6">
                <div>
                    <label class="block mb-2">Nome do Artista</label>
                ...
                <button class="bg-red-500 text-white px-6 py-2 rounded hover:bg-red-700">Salvar Alterações</button>
            </form>
        </main>
    </div>
</x-app-layout>
